...
# ---------------------- 후속질문 ----------------------
followup_set_1 = {
    "Q1": "러닝 동호회나 마라톤에 잘 어울리는 운동화는 어떤 게 있을까요?",
    "Q2": "잘 달리는 느낌이 드는 운동화는 어떤 운동화일까요?",
    "Q3": "러닝할 때 가장 돋보일 수 있는 운동화는 어떤 것이 있을까요?"
}
followup_set_2 = {
    "Q4": "깔끔하고 세련된 브랜드 운동화는 어떤 것이 있을까요?",
    "Q5": "활동적이고 에너지 넘치는 브랜드 운동화는 어떤 것이 있을까요?",
    "Q6": "'내 발에 잘 맞는다'고 느낄 수 있는 운동화는 어떤 것이 있을까요?"
}
